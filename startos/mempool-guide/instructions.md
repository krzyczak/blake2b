...
- [Mempool Guide source](https://github.com/Retropex/mempool) — the fork used by this package.
- [Original Mempool project](https://github.com/mempool/mempool) — upstream project overview and API reference.
...
The public site's transaction queue is **not** downloaded. This service always displays the mempool known by your own Bitcoin node, so its projected queue can differ substantially from mempool.guide.
