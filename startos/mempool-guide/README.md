...
| `MEMPOOL.POOLS_JSON_URL` / `_TREE_URL`           | loopback           | GitHub             | The bundled snapshot, so no start needs the network and no boot reaches out to `api.github.com`                                             |
