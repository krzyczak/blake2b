...
export const long = {
  en_US: `This private StartOS build runs Bitcoin Knots v29.4.1.knots20260508rc4 on the BIP-110/RDTS mainnet chain. It changes proof of work to BLAKE2b header v2 at block 961,640 and enforces the consensus headline "8-30 NYPost Deride And Conquer". Upgrading an existing RDTS node can cause a deep reorganization away from SHA256d blocks after 961,639. The split chains have no replay protection.
...
El paquete conserva el ID y el volumen de datos del paquete oficial de Start9, por lo que actualiza el servicio Bitcoin Knots existente sin volver a descargar la cadena.`,
  de_DE: `Dieser private StartOS-Build führt Bitcoin Knots v29.4.1.knots20260508rc4 auf der BIP-110/RDTS-Mainnet-Kette aus. Er wechselt bei Block 961.640 auf BLAKE2b-Proof-of-Work mit Header v2 und erzwingt die Konsens-Schlagzeile „8-30 NYPost Deride And Conquer“. Das Upgrade eines bestehenden RDTS-Knotens kann eine tiefe Reorganisation weg von SHA256d-Blöcken nach 961.639 auslösen. Die getrennten Ketten haben keinen Replay-Schutz.
