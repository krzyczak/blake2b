...
// Retain the loose tip-age limit used while the pre-BLAKE2b RDTS chain was
// stalled. Optional rather than enforced in formToFile: the departure
// migrations have to be able to strip it, and an enforced field cannot be.
