...
export default {
  es_ES: {
    ...
    802: "El índice de transacciones se reconstruirá una vez que se inicie Bitcoin Knots nuevamente, a menos que 'Índice Coinstats' esté deshabilitado en la configuración. Por favor, no haga esto a menos que comprenda completamente lo que está haciendo.",
    ...
    902: "El índice Coinstats se reconstruirá una vez que se inicie Bitcoin Knots nuevamente, a menos que 'Índice de transacciones' esté deshabilitado en la configuración. Por favor, no haga esto a menos que comprenda completamente lo que está haciendo.",
    ...
    1701: 'La interfaz ZeroMQ es útil para algunas aplicaciones que pueden requerir datos relacionados con eventos de bloques y transacciones de Bitcoin Knots. Por ejemplo, LND requiere que ZeroMQ esté habilitado para que LND obtenga los datos de bloque más recientes',
    1702: 'Índice de transacciones',
    1703: 'Al habilitar el índice de transacciones (txindex), Bitcoin Knots construirá un índice de transacciones completo. Esto permite que Bitcoin Knots acceda a cualquier transacción con comandos como `getrawtransaction`.',
    ...
    1717: 'BTC/kB',
    1718: 'Poda',
    1719: 'Establecer el tamaño máximo de la blockchain que desea almacenar en disco. Establecer en 0 para almacenar toda la blockchain (archivo completo).',
    ...
    1725: 'Tamaño máximo del lote de escritura de la base de datos en bytes. Los valores más altos acelerarán las secciones críticas cuando el conjunto utxo se escribe en disco desde la memoria en lotes grandes.',
    1726: 'Bytes',
    ...
    1232: 'Disable I2P',
    1233: 'Embedded I2P Daemon (i2pd)',
    1234: 'Custom I2P SAM Address',
    1235: 'I2P SAM Address',
    1255: 'Conexiones máximas',
    1256: 'Establecer el número máximo de conexiones a mantener con pares. Bitcoin reserva 11 de ellas para sus propios pares salientes; el resto son ranuras entrantes, compartidas entre pares de internet y servicios de este servidor que obtienen bloques por P2P, como Electrs. El mínimo mantiene libres las suficientes como para que uno de esos servicios pueda reclamar una ranura aunque el resto estén ocupadas. Para reducir el ancho de banda, es preferible usar Objetivo máximo de subida (Otras configuraciones), cuyo límite no se aplica a esos servicios, o Solo bloques (Configuración de Mempool).',
    1257: 'Make Public',
    1258: 'Allow other nodes to find your server on the network.',
    1259: 'IP Address and port of an external I2P daemon SAM bridge (e.g., 192.168.1.1:7656)',
    1260: 'A valid IP address and port number (e.g., 192.168.1.1:7656)',
    // Knots mempool additions
    1516: 'Enable Full RBF',
    1517: 'Policy for your node to use for relaying and mining unconfirmed transactions.',
    1518: 'Permit Bare Datacarrier',
    1519: 'Relay transactions that only have data carrier outputs',
    1520: 'Reject Parasites',
    1521: 'Reject parasite transactions',
    1522: 'Reject Tokens',
    1523: 'Reject tokens transactions (runes)',
    1524: 'Mempool Replacement',
    1525: 'Set to disabled to disable RBF entirely, "fee,optin" to honour RBF opt-out signal, or "fee,-optin" to always RBF aka full RBF',
    1526: 'Mempool TRUC',
    1527: 'Behaviour for transactions requesting TRUC limits: "reject" the transactions entirely, "accept" them just like any other, or "enforce" to impose their requested restrictions',
    1528: 'Reject',
    1529: 'Accept',
    1530: 'Enforce',
    1531: 'Permit Bare Anchor',
    1532: 'Relay transactions that only have ephemeral anchor outputs',
    1533: 'Permit Ephemeral',
    1534: 'Relay transaction packages that include ephemeral outputs defined by comma-separated options (prefix each by \'-\' to force off): "anchor" to allow minimal anyone-can-spend anchors, "send" to allow ordinary output types to be considered ephemeral, and "dust" to allow for dust-amount outputs rather than strictly zero-value',
    1535: 'Min Transaction Relay Fee',
    1536: 'Fee rates (in BTC/kB) smaller than this are considered zero fee for relaying, mining and transaction creation',
    1537: 'Bytes Per Sigop',
    1538: 'Equivalent bytes per sigop in transactions for relay and mining',
    1539: 'Bytes Per Sigop Strict',
    1540: 'Minimum bytes per sigop in transactions we relay and mine',
    1541: 'Max Legacy Sigops',
    1542: 'Maximum number of legacy sigops allowed in transactions we relay and mine, as measured by BIP54',
    1543: 'Max Ancestor Count',
    1544: 'Do not accept transactions if number of in-mempool ancestors is <n> or more',
    1545: 'Max Ancestor Size',
    1546: 'Do not accept transactions whose size with all in-mempool ancestors exceeds <n> kilobytes',
    1547: 'Max Descendant Count',
    1548: 'Do not accept transactions if any ancestor would have <n> or more in-mempool descendants',
    1549: 'Max Descendant Size',
    1550: 'Do not accept transactions if any ancestor would have more than <n> kilobytes of in-mempool descendants',
    1551: 'Permit Bare Pubkey',
    1552: 'Relay legacy pubkey outputs',
    1553: 'Max Script Size',
    1554: 'Maximum size of scripts we relay and mine, in bytes',
    1555: 'Datacarrier Cost',
    1556: 'Treat extra data in transactions as at least N vbytes per actual byte',
    1557: 'Accept Non-Standard Datacarrier',
    1558: 'Relay and mine non-OP_RETURN datacarrier injection',
    1559: 'Dust Relay Fee',
    1560: 'Fee rate (in BTC/kvB) used to define dust, the value of an output such that it will cost more than its value in fees at this fee rate to spend it.',
    1561: 'Accept Unknown Witness',
    1562: 'Relay transactions sending to unknown witness script versions',
    1563: 'Min Relay Coin Blocks',
    1564: 'Minimum coin blocks (measured in sat per block) that a transaction must be spending to be relayed',
    1565: 'Min Relay Maturity',
    1566: 'Minimum number of blocks that inputs must mature before being spent in transactions we relay',
    1567: 'Blocks',
    // Knots other additions
    1741: 'Software Expiry',
    1742: 'Stop working after this POSIX timestamp (set to 0 to disable)',
    1743: 'timestamp',
    1744: 'Template Construction',
    1745: 'Set limits for block size/weight',
    1746: 'Max Block Size',
    1747: 'Maximum block size in bytes',
    1748: 'Max Block Weight',
    1749: 'Maximum block weight in vBytes',
    1750: 'vBytes',
    1751: 'Compact Block Reconstructions',
    1752: 'Settings for compact block reconstructions',
    1753: 'Block Reconstruction Extra TXN',
    1754: 'Extra transactions to keep in memory for compact block reconstructions',
    1755: 'Block Reconstruction Extra TXN Size',
    1756: 'Upper limit of memory usage (in megabytes) for keeping extra transactions in memory for compact block reconstructions',
    1757: 'NAT-PMP',
    1758: 'Use PCP or NAT-PMP to map the listening port.',
    1759: 'Objetivo máximo de subida',
    1760: "Tries to keep outbound traffic under the given target in MiB per 24h. Limit does not apply to peers with 'download' permission or blocks created within past week. 0 = no limit.",
    // Wallet actions
    1900: 'Get Balance',
    1901: 'Get the balance of your Bitcoin wallet.',
    1910: 'Get Address',
    1911: 'Get a new segwit address.',
    1912: 'Your new address: ${stdout}',
    1920: 'Send Coins',
    1921: 'Send coins to a Bitcoin address.',
    1922: 'Address',
    1923: 'The Bitcoin address you want to send the funds.',
    1924: 'Must be alphanumeric.',
    1925: 'Amount',
    1926: 'Amount of the transaction. (in BTC)',
    1927: 'Fee',
    1928: 'Fees in sat/vbytes you want to pay for the transaction.',
    1930: 'Send All Coins',
    1931: 'Send all coins to a Bitcoin address.',
    1940: 'Sign Message',
    1941: 'Sign a message with one of your Bitcoin addresses.',
    1942: 'The Bitcoin address you want to use to sign the message.',
    1943: 'Message',
    1944: 'The message you want to sign.',
    1945: 'Your signature: ${stdout}',
    1950: 'TXID',
    1951: 'Transaction ID',
    1952: 'Prioritize Transaction',
    1953: 'Prioritize transaction with a specific fee delta.',
    1954: 'Priority Delta',
    1955: 'The transaction selection algorithm considers the tx as it would have a higher priority',
    1956: 'Fee Delta',
    1957: 'The fee value (in satoshis) to add (or subtract, if negative).',
    1958: '${txid} has been prioritized.',
    1959: 'Prioritize transaction has failed',
    // actions/backupwallet.ts
    2500: 'Backup wallet',
    2501: 'Backup wallet in a file for startOS system backup',
    2502: 'Your wallet has backup in coin.dat',
    // actions/restorewallet.ts
    2600: 'Restore wallet',
    2601: 'Restore wallet from the backup',
    2602: 'Your wallet has been restored',
    ...
    2704: 'No eliminada',
    2705: 'La cartera seleccionada no se puede eliminar desde aquí. Seleccione otra cartera con la acción Seleccionar cartera, o gestiónela desde el servicio que la creó.',
    2706: 'La cartera ${wallet} ha sido eliminada.',
    3100: 'Seleccionar cartera',
    3101: 'Elija sobre qué cartera operan las acciones de Cartera. Actualmente seleccionada: ${wallet}',
  ...
  de_DE: {
    ...
    802: "Der Transaktionsindex wird neu erstellt, sobald Bitcoin Knots erneut gestartet wird, es sei denn, 'Coinstats-Index' ist in den Konfigurationseinstellungen deaktiviert. Bitte tun Sie dies nicht, es sei denn, Sie verstehen vollständig, was Sie tun.",
    ...
    902: "Der Coinstats-Index wird neu erstellt, sobald Bitcoin Knots erneut gestartet wird, es sei denn, 'Transaktionsindex' ist in den Konfigurationseinstellungen deaktiviert. Bitte tun Sie dies nicht, es sei denn, Sie verstehen vollständig, was Sie tun.",
    ...
    1701: 'Die ZeroMQ-Schnittstelle ist nützlich für einige Anwendungen, die Daten zu Block- und Transaktionsereignissen von Bitcoin Knots benötigen könnten. Beispielsweise muss LND ZeroMQ aktiviert haben, damit LND die neuesten Blockdaten erhält',
    1702: 'Transaktionsindex',
    1703: 'Durch Aktivieren des Transaktionsindex (txindex) erstellt Bitcoin Knots einen vollständigen Transaktionsindex. Dadurch kann Bitcoin Knots mit Befehlen wie `getrawtransaction` auf jede Transaktion zugreifen.',
    ...
    1717: 'BTC/kB',
    1718: 'Beschneidung',
    1719: 'Legen Sie die maximale Größe der Blockchain fest, die Sie auf der Festplatte speichern möchten. Auf 0 setzen, um die gesamte Blockchain zu speichern (vollständiges Archiv).',
    ...
    1725: 'Maximale Schreibstapelgröße der Datenbank in Bytes. Höhere Werte beschleunigen die kritischen Abschnitte, wenn der UTXO-Satz in großen Stapeln vom Speicher auf die Festplatte geschrieben wird.',
    1726: 'Bytes',
    1727: 'Blockfilter',
    ...
    1256: 'Maximale Anzahl der Verbindungen zu Peers festlegen. Bitcoin reserviert 11 davon für seine eigenen ausgehenden Peers; der Rest sind eingehende Plätze, die sich Peers aus dem Internet und Dienste auf diesem Server teilen, die Blöcke über P2P abrufen, etwa Electrs. Der Mindestwert hält genug davon frei, dass einer dieser Dienste noch einen Platz bekommen kann, wenn die übrigen belegt sind. Um Bandbreite zu sparen, verwenden Sie besser Maximales Upload-Ziel (Weitere Einstellungen), dessen Limit für diese Dienste nicht gilt, oder Nur Blöcke (Mempool-Einstellungen).',
    1257: 'Make Public',
    1258: 'Allow other nodes to find your server on the network.',
    1259: 'IP Address and port of an external I2P daemon SAM bridge (e.g., 192.168.1.1:7656)',
    1260: 'A valid IP address and port number (e.g., 192.168.1.1:7656)',
    ...
    2704: 'Nicht entfernt',
    2705: 'Die ausgewählte Wallet kann von hier aus nicht entfernt werden. Wählen Sie mit der Aktion „Wallet auswählen“ eine andere Wallet oder verwalten Sie sie über den Dienst, der sie erstellt hat.',
    2706: 'Wallet ${wallet} wurde entfernt.',
    3100: 'Wallet auswählen',
    3101: 'Wählen Sie, auf welche Wallet die Wallet-Aktionen angewendet werden. Aktuell ausgewählt: ${wallet}',
  ...
  pl_PL: {
    ...
    802: "Indeks transakcji zostanie przebudowany po ponownym uruchomieniu Bitcoin Knots, chyba że 'Indeks Coinstats' jest wyłączony w ustawieniach konfiguracji. Proszę tego nie robić, chyba że w pełni rozumiesz, co robisz.",
    ...
    902: "Indeks Coinstats zostanie przebudowany po ponownym uruchomieniu Bitcoin Knots, chyba że 'Indeks transakcji' jest wyłączony w ustawieniach konfiguracji. Proszę tego nie robić, chyba że w pełni rozumiesz, co robisz.",
    ...
    1701: 'Interfejs ZeroMQ jest przydatny dla niektórych aplikacji, które mogą wymagać danych związanych z blokami i zdarzeniami transakcji z Bitcoin Knots. Na przykład LND wymaga włączenia ZeroMQ, aby LND otrzymywał najnowsze dane bloku',
    1702: 'Indeks transakcji',
    1703: 'Włączając indeks transakcji (txindex), Bitcoin Knots zbuduje pełny indeks transakcji. Pozwala to Bitcoin Knots na dostęp do dowolnej transakcji za pomocą poleceń takich jak `getrawtransaction`.',
    ...
    1717: 'BTC/kB',
    1718: 'Przycinanie',
    1719: 'Ustaw maksymalny rozmiar blockchain, który chcesz przechowywać na dysku. Ustaw na 0, aby przechowywać cały blockchain (pełne archiwum).',
    ...
    1256: 'Ustaw maksymalną liczbę połączeń z peerami. Bitcoin rezerwuje 11 z nich na własne połączenia wychodzące; reszta to miejsca przychodzące, dzielone między peerów z internetu a usługi na tym serwerze, które pobierają bloki przez P2P, takie jak Electrs. Minimum utrzymuje ich na tyle dużo wolnych, że jedna z tych usług nadal może zająć miejsce, gdy pozostałe są zajęte. Aby zmniejszyć zużycie łącza, lepiej użyć Maksymalny limit wysyłania (Inne ustawienia), którego limit nie dotyczy tych usług, albo Tylko bloki (Ustawienia Mempool).',
    1257: 'Make Public',
    1258: 'Allow other nodes to find your server on the network.',
    1259: 'IP Address and port of an external I2P daemon SAM bridge (e.g., 192.168.1.1:7656)',
    1260: 'A valid IP address and port number (e.g., 192.168.1.1:7656)',
    ...
    1757: 'NAT-PMP',
    1758: 'Use PCP or NAT-PMP to map the listening port.',
    1759: 'Maksymalny limit wysyłania',
    1760: "Tries to keep outbound traffic under the given target in MiB per 24h. Limit does not apply to peers with 'download' permission or blocks created within past week. 0 = no limit.",
    // Wallet actions
    1900: 'Get Balance',
    1901: 'Get the balance of your Bitcoin wallet.',
    ...
    2704: 'Nie usunięto',
    2705: 'Wybranego portfela nie można usunąć z tego miejsca. Wybierz inny portfel za pomocą akcji Wybierz portfel lub zarządzaj nim z poziomu usługi, która go utworzyła.',
    2706: 'Portfel ${wallet} został usunięty.',
    3100: 'Wybierz portfel',
    3101: 'Wybierz, na którym portfelu działają akcje Portfela. Obecnie wybrany: ${wallet}',
  ...
  fr_FR: {
    ...
    1717: 'BTC/kB',
    1718: 'Élagage',
    1719: 'Définir la taille maximale de blockchain que vous souhaitez stocker sur le disque. Régler sur 0 pour stocker la blockchain entière (archive complète).',
    ...
    1724: 'Lot de base de données',
    1725: "Taille maximale du lot d'écriture de la base de données en octets. Des valeurs plus élevées accéléreront les sections critiques lorsque l'ensemble utxo est écrit sur le disque depuis la mémoire en grands lots.",
    1726: 'Octets',
    ...
    1256: "Définir le nombre maximum de connexions à maintenir avec les pairs. Bitcoin en réserve 11 pour ses propres pairs sortants ; le reste sont des emplacements entrants, partagés entre les pairs d'internet et les services de ce serveur qui récupèrent les blocs via P2P, comme Electrs. Le minimum en garde assez de libres pour qu'un de ces services puisse encore obtenir un emplacement quand les autres sont pris. Pour réduire la bande passante, préférez Objectif maximal d'envoi (Autres paramètres), dont la limite ne s'applique pas à ces services, ou Blocs uniquement (Paramètres du Mempool).",
    1257: 'Make Public',
    1258: 'Allow other nodes to find your server on the network.',
    1259: 'IP Address and port of an external I2P daemon SAM bridge (e.g., 192.168.1.1:7656)',
    1260: 'A valid IP address and port number (e.g., 192.168.1.1:7656)',
    ...
    2704: 'Non supprimé',
    2705: "Le portefeuille sélectionné ne peut pas être supprimé d'ici. Sélectionnez un autre portefeuille avec l'action Sélectionner le portefeuille, ou gérez-le depuis le service qui l'a créé.",
    2706: 'Le portefeuille ${wallet} a été supprimé.',
    3100: 'Sélectionner le portefeuille',
    3101: 'Choisissez le portefeuille sur lequel les actions Portefeuille opèrent. Actuellement sélectionné : ${wallet}',
