...
- [BLAKE2b mining guide](https://btc-blake2b.org/mining) — activation height, required headline, and compatible mining software.
...
2. Resolve the **RDTS Chain Opt-In** critical task. This version follows the separate BIP-110/RDTS chain, switches to BLAKE2b header-v2 proof of work at block 961,640, and has no replay protection against the Bitcoin Core chain. To follow the Bitcoin Core chain, install **Bitcoin Core** or **Bitcoin Knots (pre-RDTS)** instead.
